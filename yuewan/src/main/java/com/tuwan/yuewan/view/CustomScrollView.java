...
public class CustomScrollView extends ScrollView {
    ...
    private ImageView img_top_header; // 下拉刷新
//    private TextView lastUpdatedTextView;// 最新更新
    private LinearLayout lly_header_loading;
    private ImageView img_header_one,img_header_two,img_header_three;
    ...
    public void initView(Context context) {
        ...
        img_top_header = (ImageView) headView.findViewById(R.id.img_top_header);
        lly_header_loading = (LinearLayout) headView.findViewById(R.id.lly_header_loading);
        img_header_one = (ImageView) headView.findViewById(R.id.img_header_one);
        img_header_two = (ImageView) headView.findViewById(R.id.img_header_two);
        img_header_three = (ImageView) headView.findViewById(R.id.img_header_three);
...
//                lastUpdatedTextView.setVisibility(View.VISIBLE);
                ...
                img_top_header.setImageResource(R.drawable.icon_second);
                lly_header_loading.setVisibility(View.GONE);
                break;
...
//                lastUpdatedTextView.setVisibility(View.VISIBLE);
                ...
                img_top_header.setImageResource(R.drawable.icon_first);
                lly_header_loading.setVisibility(View.GONE);
                break;
            ...
            case REFRESHING:
                ...
                lly_header_loading.setVisibility(View.VISIBLE);
                img_top_header.setImageResource(R.drawable.icon_third);
                ...
                img_header_one.startAnimation(animation1);
                animation1.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        if (endState == 0) {
                            img_header_two.startAnimation(animation2);
                        }else {
                            endState = 0;
                        }
                    }
                ...
                animation2.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        if (endState == 0) {
                            img_header_three.startAnimation(animation3);
                        }else {
                            endState = 0;
                        }
                    }
