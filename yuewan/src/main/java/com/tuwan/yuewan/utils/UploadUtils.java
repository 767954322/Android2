...
public class UploadUtils {
     ...
     * @author ylbf_dev
     */
    public static String uploadFile(final String cookie, final ArrayList<File> imagefiles, final ArrayList<File> videofiles, final String uploadUrl, final ArrayList<String> name, final ArrayList<Object> values) {
