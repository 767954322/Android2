...
public class ENPlayView extends View {
    ...
    public ENPlayView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.shuyu.gsyvideoplayer.R.styleable.play);
        int lineColor = ta.getColor(com.shuyu.gsyvideoplayer.R.styleable.play_play_line_color, DEFAULT_LINE_COLOR);
        int bgLineColor = ta.getColor(com.shuyu.gsyvideoplayer.R.styleable.play_play_bg_line_color, DEFAULT_BG_LINE_COLOR);
        int lineWidth = ta.getInteger(com.shuyu.gsyvideoplayer.R.styleable.play_play_line_width, dp2px(DEFAULT_LINE_WIDTH));
        int bgLineWidth = ta.getInteger(com.shuyu.gsyvideoplayer.R.styleable.play_play_bg_line_width, dp2px(DEFAULT_BG_LINE_WIDTH));
        ta.recycle();
