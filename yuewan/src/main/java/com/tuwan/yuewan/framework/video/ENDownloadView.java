package com.tuwan.yuewan.framework.video;
...
public class ENDownloadView extends View {
    ...
    public ENDownloadView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.shuyu.gsyvideoplayer.R.styleable.download);
        int lineColor = ta.getColor(com.shuyu.gsyvideoplayer.R.styleable.download_download_line_color, DEFAULT_LINE_COLOR);
        int bgLineColor = ta.getColor(com.shuyu.gsyvideoplayer.R.styleable.download_download_bg_line_color, DEFAULT_BG_LINE_COLOR);
        int textColor = ta.getColor(com.shuyu.gsyvideoplayer.R.styleable.download_download_text_color, DEFAULT_TEXT_COLOR);
        int lineWidth = ta.getInteger(com.shuyu.gsyvideoplayer.R.styleable.download_download_line_width, DEFAULT_LINE_WIDTH);
        int bgLineWidth = ta.getInteger(com.shuyu.gsyvideoplayer.R.styleable.download_download_bg_line_width, DEFAULT_BG_LINE_WIDTH);
        int textSize = ta.getInteger(com.shuyu.gsyvideoplayer.R.styleable.download_download_text_size, DEFAULT_TEXT_SIZE);
        ta.recycle();
