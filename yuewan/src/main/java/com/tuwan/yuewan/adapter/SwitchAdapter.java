...
public class SwitchAdapter extends BaseAdapter implements Filterable {
    ...
    public SwitchAdapter(List<String> list, Context context, FilterListener filterListener) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.switch_item1, null);
            holder = new ViewHolder();
            holder.tv_ss = (TextView) convertView.findViewById(R.id.switch_1);
            convertView.setTag(holder);
        }
        holder = (ViewHolder) convertView.getTag();
        setTvColor(list.get(position),text,holder.tv_ss);
