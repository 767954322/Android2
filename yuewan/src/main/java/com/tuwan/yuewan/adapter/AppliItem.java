...
public class AppliItem extends BaseAdapter {
    Context context;
    private List<InBean.OnlinegBean> dataBeen = new ArrayList<>();
    private ViewHolder holder;

    public AppliItem(Context context, List<InBean.OnlinegBean> dataBeen) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        InBean.OnlinegBean dataBean = dataBeen.get(position);
