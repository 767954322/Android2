...
import com.tuwan.yuewan.nim.uikit.common.media.audioplayer.Playable;
...
public class MsgViewHolderAudio extends MsgViewHolderBase {
    ...
    private void endPlayAnim() {
        if (isReceivedMessage()) {
            animationView.setBackgroundResource(R.drawable.ic_service_speech_3);
        } else {
            animationView.setBackgroundResource(R.drawable.ic_service_speech_right_3);
        }
    }
