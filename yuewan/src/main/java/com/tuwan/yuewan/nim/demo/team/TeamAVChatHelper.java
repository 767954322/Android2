package com.tuwan.yuewan.nim.demo.team;
...
import com.tuwan.yuewan.nim.demo.teamavchat.activity.TeamAVChatActivity;
...
public class TeamAVChatHelper {
        ...
        public void onEvent(CustomNotification customNotification) {
            try {
                ...
                if (isTeamAVChatInvite(jsonObject)) {
                    ...
                    // 接收到群视频邀请，启动来点界面
                    LogUtil.e("receive team video chat notification " + teamId + " room " + roomName);
                    if (isTeamAVChatting || AVChatProfile.getInstance().isAVChatting()) {
                        LogUtil.e("cancel launch team av chat isTeamAVChatting = " + isTeamAVChatting);
                        Toast.makeText(DemoCache.getContext(), "正在进行视频通话", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    LogUtil.e("isSyncComplete = " + isSyncComplete);
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                if (!DemoCache.isMainTaskLaunching()) {
                    ...
                    LogUtil.e("launch TeamAVChatActivity delay for WelComeActivity is Launching");
                    launchActivity(teamId, roomName, accounts, teamName);
                }
            }
        };
    ...
    public boolean checkOfflineOutTime(CustomNotification notification) {
        ...
        LogUtil.e("rev offline team AVChat request time = " + time);
