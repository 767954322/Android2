...
import com.tuwan.yuewan.nim.demo.location.activity.LocationAmapActivity;
import com.tuwan.yuewan.nim.demo.location.activity.LocationExtras;
import com.tuwan.yuewan.nim.demo.location.activity.NavigationAmapActivity;
                    ...
                    new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            try {
                                ...
                                LogUtil.e( "start ACTION_LOCATION_SOURCE_SETTINGS error");
                            }
