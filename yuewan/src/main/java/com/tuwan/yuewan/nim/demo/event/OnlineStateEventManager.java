package com.tuwan.yuewan.nim.demo.event;
...
public class OnlineStateEventManager {
    ...
    private static FriendDataCache.FriendDataChangedObserver observer = new FriendDataCache.FriendDataChangedObserver() {
        ...
        public void onAddedOrUpdatedFriends(List<String> accounts) {
            ...
            LogUtil.e("added or updated friends subscribe online state " + subs);
    ...
    private static void registerOnlineStatusObserver() {
        NIMClient.getService(AuthServiceObserver.class).observeOnlineStatus(new Observer<StatusCode>() {
            ...
            public void onEvent(StatusCode statusCode) {
                ...
                LogUtil.e("status change to loginNetease so publish state and subscribe");
    ...
    private static BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(ConnectivityManager.CONNECTIVITY_ACTION)) {
                ...
                LogUtil.e("BroadcastReceiver CONNECTIVITY_ACTION " + info.getType() + info.getTypeName() + info.getExtraInfo());
    ...
    private static void receivedOnlineStateEvents(List<Event> events) {
        ...
        for (Event event : events) {
            if (NimOnlineStateEvent.isOnlineStateEvent(event)) {
                ...
                LogUtil.e("received and cached onlineState of account " + event.getPublisherAccount());
            }
        }
    ...
    public static void publishOnlineStateEvent(boolean force) {
        ...
        LogUtil.e("publish online event value = " + event.getEventValue() + " config = " + event.getConfig());
    ...
    public static void checkSubscribe(String account) {
        ...
        if (!OnlineStateEventCache.hasSubscribed(account)) {
            ...
            LogUtil.e("display online state but not subscribe " + account);
    ...
    private static boolean enableOnlineStateEvent() {
        ...
        return enable = (packageName != null && packageName.equals("com.tuwan.yuewan.nim.demo"));
    }
}