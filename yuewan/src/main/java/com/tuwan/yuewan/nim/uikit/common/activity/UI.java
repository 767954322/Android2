...
import com.tuwan.yuewan.nim.uikit.common.util.sys.ReflectionUtil;
...
public abstract class UI extends RxAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogUtil.e("activity: " + getClass().getSimpleName() + " onCreate()");
    }
    ...
    protected void onDestroy() {
        ...
        LogUtil.e("activity: " + getClass().getSimpleName() + " onDestroy()");
        destroyed = true;
    }
