package com.tuwan.yuewan.nim.uikit.common.ui.drop;
...
public class DropManager {
    ...
    static final int TEXT_SIZE = ScreenUtil.dip2px(9); // 9dp

    static final int CIRCLE_RADIUS = ScreenUtil.dip2px(9); // 9dip
