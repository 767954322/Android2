package com.tuwan.yuewan.nim.uikit.core;
...
import com.tuwan.yuewan.nim.uikit.cache.DataCacheManager;
...
import com.tuwan.yuewan.nim.uikit.chatroom.fragment.ChatRoomMessageFragment;
import com.tuwan.yuewan.nim.uikit.chatroom.viewholder.ChatRoomMsgViewHolderBase;
import com.tuwan.yuewan.nim.uikit.chatroom.viewholder.ChatRoomMsgViewHolderFactory;
import com.tuwan.yuewan.nim.uikit.common.util.storage.StorageType;
import com.tuwan.yuewan.nim.uikit.common.util.storage.StorageUtil;
import com.tuwan.yuewan.nim.uikit.common.util.sys.ScreenUtil;
import com.tuwan.yuewan.nim.uikit.contact.ContactEventListener;
...
import com.tuwan.yuewan.nim.uikit.custom.DefaultContactEventListener;
import com.tuwan.yuewan.nim.uikit.custom.DefaultContactProvider;
import com.tuwan.yuewan.nim.uikit.custom.DefaultP2PSessionCustomization;
import com.tuwan.yuewan.nim.uikit.custom.DefaultRecentCustomization;
import com.tuwan.yuewan.nim.uikit.custom.DefaultTeamSessionCustomization;
import com.tuwan.yuewan.nim.uikit.custom.DefaultUserInfoProvider;
import com.tuwan.yuewan.nim.uikit.glide.ImageLoaderKit;
import com.tuwan.yuewan.nim.uikit.plugin.CustomPushContentProvider;
import com.tuwan.yuewan.nim.uikit.plugin.LocationProvider;
...
import com.tuwan.yuewan.nim.uikit.plugin.OnlineStateContentProvider;
...
import com.tuwan.yuewan.nim.uikit.session.activity.TeamMessageActivity;
...
import com.tuwan.yuewan.nim.uikit.session.viewholder.MsgViewHolderFactory;
import com.tuwan.yuewan.nim.uikit.team.activity.AdvancedTeamInfoActivity;
import com.tuwan.yuewan.nim.uikit.team.activity.NormalTeamInfoActivity;
...
public final class NimUIKitImpl {
    ...
    public static void init(Context context, UserInfoProvider userInfoProvider, ContactProvider contactProvider) {
        ...
        if (!TextUtils.isEmpty(getAccount())) {
            DataCacheManager.buildDataCache(); // build data cache on auto loginNetease
            getImageLoaderKit().buildImageCache(); // build image cache on auto loginNetease
        }
    }
    ...
    */
    ...
    //    DefaultP2PSessionCustomization
