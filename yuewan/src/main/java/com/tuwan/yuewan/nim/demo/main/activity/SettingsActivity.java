package com.tuwan.yuewan.nim.demo.main.activity;
...
import com.tuwan.yuewan.nim.demo.avchat.activity.AVChatSettingsActivity;
...
import com.tuwan.yuewan.nim.demo.contact.activity.UserProfileSettingActivity;
import com.tuwan.yuewan.nim.demo.main.adapter.SettingsAdapter;
import com.tuwan.yuewan.nim.demo.main.model.SettingTemplate;
import com.tuwan.yuewan.nim.demo.main.model.SettingType;
...
//                UserPreferences.getNotificationFoldedToggle()));
        ...
        items.add(new SettingTemplate(TAG_SPEAKER, getString(R.string.msg_speaker), SettingType.TYPE_TOGGLE,
                com.tuwan.yuewan.nim.uikit.core.UserPreferences.isEarPhoneModeEnable()));
    ...
    public void onSwitchChange(SettingTemplate item, boolean checkState) {
        switch (item.getId()) {
            case TAG_NOTICE:
                ...
                break;
            case TAG_SPEAKER:
                com.tuwan.yuewan.nim.uikit.core.UserPreferences.setEarPhoneModeEnable(checkState);
