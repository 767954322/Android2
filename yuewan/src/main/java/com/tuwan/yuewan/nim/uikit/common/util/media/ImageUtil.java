package com.tuwan.yuewan.nim.uikit.common.util.media;
...
import com.tuwan.yuewan.nim.uikit.session.viewholder.MsgViewHolderThumbBase;
...
public class ImageUtil {
    ...
    public static Boolean scaleImage(File srcFile, File dstFile, int dstMaxWH, CompressFormat compressFormat, int quality) {
        ...
        try {
            ...
            float rotate;
            String mimeType = com.tuwan.yuewan.nim.uikit.common.media.picker.util.BitmapUtil.getImageType(srcFile.getAbsolutePath());
