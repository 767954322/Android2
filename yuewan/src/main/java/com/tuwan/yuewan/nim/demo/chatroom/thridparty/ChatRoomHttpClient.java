package com.tuwan.yuewan.nim.demo.chatroom.thridparty;
...
import com.tuwan.yuewan.nim.demo.chatroom.helper.ExtensionHelper;
import com.tuwan.yuewan.nim.demo.config.DemoServers;
import com.tuwan.yuewan.nim.uikit.common.http.HttpClientWrapper;
import com.tuwan.yuewan.nim.uikit.common.http.NimHttpClient;
        ...
        NimHttpClient.getInstance().execute(url, headers, null, false, new NimHttpClient.NimHttpCallback() {
            ...
            public void onResponse(String response, int code, Throwable exception) {
                if (code != 200 || exception != null) {
                    LogUtil.e( "fetchChatRoomList failed : code = " + code + ", errorMsg = "
