package com.tuwan.yuewan.nim.uikit.cache;
...
//            NIMClient.getService(UserService.class).fetchUserInfo(id).setCallback(new RequestCallback<List<NimUserInfo>>() {
//                @Override
//                public void onSuccess(List<NimUserInfo> param) {
//                    Log.d("list",param.toString());
//                }
//
//                @Override
//                public void onFailed(int code) {
