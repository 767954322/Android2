package com.tuwan.yuewan.nim.demo.chatroom.helper;
...
public class ExtensionHelper {
    ...
    public static String getJsonStringFromMap(final Map<String, Object> map) {
        ...
        if (map != null && !map.isEmpty()) {
            try {
                ...
                LogUtil.e( "getJsonStringFromMap exception =" + e.getMessage());
            }
        }
    ...
    public static Map<String, Object> getMapFromJsonString(final String jsonStr) {
        ...
        try {
            ...
            LogUtil.e( "getMapFromJsonString exception =" + e.getMessage());
        }
