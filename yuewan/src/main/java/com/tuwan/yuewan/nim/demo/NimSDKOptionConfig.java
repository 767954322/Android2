...
public class NimSDKOptionConfig {
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        // 点击通知需要跳转到的界面
        config.notificationEntrance = YMainActivity.class;
        config.notificationSmallIconId = R.drawable.logo2x;
        config.notificationColor = DemoCache.getContext().getResources().getColor(R.color.color_blue_3a9efb);
        // 通知铃声的uri字符串
//        config.notificationSound = "android.resource://com.tuwan.yuewan.nim.demo/raw/msg";
