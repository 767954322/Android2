package com.tuwan.yuewan.nim.demo.teamavchat.activity;
...
import com.tuwan.yuewan.nim.demo.teamavchat.TeamAVChatNotification;
import com.tuwan.yuewan.nim.demo.teamavchat.TeamAVChatVoiceMuteDialog;
import com.tuwan.yuewan.nim.demo.teamavchat.adapter.TeamAVChatAdapter;
import com.tuwan.yuewan.nim.demo.teamavchat.module.SimpleAVChatStateObserver;
import com.tuwan.yuewan.nim.demo.teamavchat.module.TeamAVChatItem;
import com.tuwan.yuewan.nim.uikit.cache.TeamDataCache;
import com.tuwan.yuewan.nim.uikit.common.activity.UI;
import com.tuwan.yuewan.nim.uikit.common.ui.recyclerview.decoration.SpacingDecoration;
...
import static com.tuwan.yuewan.nim.demo.teamavchat.module.TeamAVChatItem.TYPE.TYPE_DATA;
...
public class TeamAVChatActivity extends UI {
    ...
    private View.OnClickListener settingBtnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (v.getId() == R.id.avchat_switch_camera) {
                // 切换前后摄像头
                mVideoCapturer.switchCamera();
            } else if (v.getId() == R.id.avchat_enable_video) {
                // 视频
            ...
            } else if (v.getId() == R.id.avchat_enable_audio) {
                // 麦克风开关
            ...
            } else if (v.getId() == R.id.avchat_volume) {
                // 听筒扬声器切换
            ...
            } else if (v.getId() == R.id.avchat_shield_user) {
                // 屏蔽用户音频
                disableUserAudio();
            } else if (v.getId() == R.id.hangup) {
                // 挂断
                hangup();
                finish();
            }
