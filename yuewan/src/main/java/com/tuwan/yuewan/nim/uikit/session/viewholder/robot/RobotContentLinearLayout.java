package com.tuwan.yuewan.nim.uikit.session.viewholder.robot;
...
import com.tuwan.yuewan.nim.uikit.robot.model.RobotBotContent;
import com.tuwan.yuewan.nim.uikit.robot.model.RobotResponseContent;
import com.tuwan.yuewan.nim.uikit.robot.parser.elements.base.Element;
import com.tuwan.yuewan.nim.uikit.robot.parser.elements.element.ImageElement;
import com.tuwan.yuewan.nim.uikit.robot.parser.elements.element.TextElement;
import com.tuwan.yuewan.nim.uikit.robot.parser.elements.group.LinkElement;
import com.tuwan.yuewan.nim.uikit.robot.parser.elements.group.TemplateRoot;
...
public class RobotContentLinearLayout extends LinearLayout {
    ...
    private void convertTemplateToViews(final TemplateRoot template, final ClickableChildView robot) {
        List<com.tuwan.yuewan.nim.uikit.robot.parser.elements.group.LinearLayout> robotLinearLayouts = template.getElements();
        if (robotLinearLayouts == null) {
            return;
        }
        for (com.tuwan.yuewan.nim.uikit.robot.parser.elements.group.LinearLayout robotLinearLayout : robotLinearLayouts) {
