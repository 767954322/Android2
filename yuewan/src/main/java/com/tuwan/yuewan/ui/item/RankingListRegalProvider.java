...
import com.tuwan.yuewan.ui.fragment.RankingRegalListFragment;
...
public class RankingListRegalProvider extends ItemViewProvider<RegalRankingListBean.DataBean, RankingListRegalProvider.ViewHolder> {


    private final RankingRegalListFragment mContext;
...
//    Drawable mDrawableGirlSmall = YApp.getInstance().getResources().getDrawable(R.drawable.ic_gril_small);
    ...
    public RankingListRegalProvider(RankingRegalListFragment fragment) {
    ...
    @Override
    protected void onBindViewHolder(@NonNull final ViewHolder holder, @NonNull final RegalRankingListBean.DataBean bean) {
...
//                TeacherMainActivity.show(mContext,bean.uid);
        ...
        holder.mTvItemRangklingListCharm.setText("贡献值 " + bean.total);

//        AppUtils.setDataAgeAndGender(bean., bean.sex, holder.mTvItemRangklingListAge, mDrawableBoySmall, mDrawableGirlSmall);
