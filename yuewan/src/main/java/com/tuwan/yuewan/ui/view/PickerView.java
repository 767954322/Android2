...
public class PickerView extends View {
    ...
    public void setData(List<String> datas,int pos) {
//        if (pos < 4) {
//            for (int i = 0; i < pos; i++) {
//                mDataList.add(datas.get(datas.size() - (pos - i)));
//            }
//            for (int i = 0; i < datas.size() - pos; i++) {
//                mDataList.add(datas.get(i));
//            }
//        }else if (pos > datas.size() - 4){
//            for (int i = datas.size() - pos; i <  datas.size(); i++) {
//                mDataList.add(datas.get(i));
//            }
//            for (int i = 0; i < datas.size() - pos; i++) {
//                mDataList.add(datas.get(i));
...
//        }
    ...
    private void drawData(Canvas canvas) {
        ...
        // 绘制上方data
        Log.d("scaleSize",scale + "," + size + "," + x + "," + y + "," + baseline + "," + mCurrentSelected);
