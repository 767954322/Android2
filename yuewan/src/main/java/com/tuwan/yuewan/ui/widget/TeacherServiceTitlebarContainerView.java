...
import com.tuwan.yuewan.ui.widget.teacher.support.ATHeaderBehavior;
 ...
 */
@CoordinatorLayout.DefaultBehavior(TeacherServiceTitlebarContainerView.Behavior.class)
public class TeacherServiceTitlebarContainerView extends ViewGroup {
    ...
    private final float mTitleBarHeight = YApp.app.getResources().getDimensionPixelSize(R.dimen.toolbar_height);
    ...
    public TeacherServiceTitlebarContainerView(@NonNull Context context) {
        this(context, null);
    }

    public TeacherServiceTitlebarContainerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public interface OnOffsetChangeListener {
        void onOffsetChanged(TeacherServiceTitlebarContainerView header, int currOffset);
    }

    public interface OnHeaderFlingUnConsumedListener {
        int onFlingUnConsumed(TeacherServiceTitlebarContainerView header, int targetOffset, int unconsumed);
    }

    public static class Behavior extends ATHeaderBehavior<TeacherServiceTitlebarContainerView> {
        ...
        @Override
        protected boolean canDragView(TeacherServiceTitlebarContainerView view) {
        ...
        @Override
        protected int getMaxDragOffset(TeacherServiceTitlebarContainerView view) {
            return -view.getScrollRange();
        }

        @Override
        protected int getScrollRangeForDragFling(TeacherServiceTitlebarContainerView view) {
            return view.getScrollRange();
        }

        @Override
        public int setHeaderTopBottomOffset(CoordinatorLayout parent, TeacherServiceTitlebarContainerView header, int newOffset, int minOffset, int maxOffset) {
        ...
        @Override
        protected boolean fling(CoordinatorLayout coordinatorLayout, TeacherServiceTitlebarContainerView layout, int minOffset, int maxOffset, float velocityY) {
            int min = minOffset;
            int max = maxOffset;
            if (velocityY < 0) {
                // 向上滚动
        ...
        @Override
        protected void onFlingFinished(CoordinatorLayout parent, TeacherServiceTitlebarContainerView header) {
            mShouldDispatchFling = false;
            checkSnap(parent, header);
        }

        public boolean checkSnap(CoordinatorLayout parent, TeacherServiceTitlebarContainerView header) {
        ...
        @Override
        public boolean onLayoutChild(CoordinatorLayout parent, TeacherServiceTitlebarContainerView child, int layoutDirection) {
        ...
        private void animateOffsetTo(final CoordinatorLayout coordinatorLayout,
                                     final TeacherServiceTitlebarContainerView child, final int offset, float velocity) {
        ...
        private void animateToOffset(final CoordinatorLayout parent, final TeacherServiceTitlebarContainerView header, final int target, int duration) {
        ...
        @Override
        public boolean onStartNestedScroll(CoordinatorLayout coordinatorLayout, TeacherServiceTitlebarContainerView child, View directTargetChild, View target, int nestedScrollAxes) {
        ...
        @Override
        public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, TeacherServiceTitlebarContainerView child, View target, int dx, int dy, int[] consumed) {
        ...
        @Override
        public void onNestedScroll(CoordinatorLayout coordinatorLayout, TeacherServiceTitlebarContainerView child, View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
            if (dyUnconsumed < 0) {
        ...
        @Override
        public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, TeacherServiceTitlebarContainerView child, View target) {
            if (!mWasFlung) {
        ...
        @Override
        public boolean onNestedPreFling(CoordinatorLayout coordinatorLayout, TeacherServiceTitlebarContainerView child, View target, float velocityX, float velocityY) {
        ...
        @Override
        public boolean onNestedFling(CoordinatorLayout coordinatorLayout, TeacherServiceTitlebarContainerView child, View target, float velocityX, float velocityY, boolean consumed) {
            mWasFlung = true;
            return false;
        }
    }
