 ...
 */
@CoordinatorLayout.DefaultBehavior(TeacherTitlebarContainerView.Behavior.class)
public class TeacherTitlebarContainerView extends ViewGroup {
    ...
    float mTitleBarHeight = YApp.app.getResources().getDimension(R.dimen.toolbar_height);
    ...
    public TeacherTitlebarContainerView(@NonNull Context context) {
        this(context, null);
    }

    public TeacherTitlebarContainerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public int getScrollRange() {
        ...
        range -= mTitleBarHeight;
        range -= mTitleBarHeight;
        range -= mBar.getPaddingTop();
        return range;
    }
    ...
    protected void onFinishInflate() {
        ...
        mBar = findViewById(R.id.titlebar_toptitle);
...
//        childTop += mBar.getMeasuredHeight();
    ...
    public interface OnOffsetChangeListener {
        void onOffsetChanged(TeacherTitlebarContainerView header, int currOffset);
    }

    public interface OnHeaderFlingUnConsumedListener {
        int onFlingUnConsumed(TeacherTitlebarContainerView header, int targetOffset, int unconsumed);
    }

    public static class Behavior extends ATHeaderBehavior<TeacherTitlebarContainerView> {
        ...
        @Override
        protected boolean canDragView(TeacherTitlebarContainerView view) {
        ...
        @Override
        protected int getMaxDragOffset(TeacherTitlebarContainerView view) {
            return -view.getScrollRange();
        }

        @Override
        protected int getScrollRangeForDragFling(TeacherTitlebarContainerView view) {
            return view.getScrollRange();
        }

        @Override
        public int setHeaderTopBottomOffset(CoordinatorLayout parent, TeacherTitlebarContainerView header, int newOffset, int minOffset, int maxOffset) {
        ...
        @Override
        protected boolean fling(CoordinatorLayout coordinatorLayout, TeacherTitlebarContainerView layout, int minOffset, int maxOffset, float velocityY) {
            int min = minOffset;
            int max = maxOffset;
            if (velocityY < 0) {
                // 向上滚动
        ...
        @Override
        protected void onFlingFinished(CoordinatorLayout parent, TeacherTitlebarContainerView header) {
            mShouldDispatchFling = false;
            checkSnap(parent, header);
        }

        public boolean checkSnap(CoordinatorLayout parent, TeacherTitlebarContainerView header) {
        ...
        @Override
        public boolean onLayoutChild(CoordinatorLayout parent, TeacherTitlebarContainerView child, int layoutDirection) {
        ...
        private void animateOffsetTo(final CoordinatorLayout coordinatorLayout,
                                     final TeacherTitlebarContainerView child, final int offset, float velocity) {
        ...
        private void animateToOffset(final CoordinatorLayout parent, final TeacherTitlebarContainerView header, final int target, int duration) {
        ...
        @Override
        public boolean onStartNestedScroll(CoordinatorLayout coordinatorLayout, TeacherTitlebarContainerView child, View directTargetChild, View target, int nestedScrollAxes) {
        ...
        @Override
        public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, TeacherTitlebarContainerView child, View target, int dx, int dy, int[] consumed) {
        ...
        @Override
        public void onNestedScroll(CoordinatorLayout coordinatorLayout, TeacherTitlebarContainerView child, View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
            if (dyUnconsumed < 0) {
        ...
        @Override
        public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, TeacherTitlebarContainerView child, View target) {
            if (!mWasFlung) {
        ...
        @Override
        public boolean onNestedPreFling(CoordinatorLayout coordinatorLayout, TeacherTitlebarContainerView child, View target, float velocityX, float velocityY) {
        ...
        @Override
        public boolean onNestedFling(CoordinatorLayout coordinatorLayout, TeacherTitlebarContainerView child, View target, float velocityX, float velocityY, boolean consumed) {
            mWasFlung = true;
            return false;
        }
    }
