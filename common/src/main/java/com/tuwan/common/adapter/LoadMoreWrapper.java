...
public class LoadMoreWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    int dimension = (int) (LibraryApplication.getInstance().getResources().getDimension(R.dimen.toolbar_height)/2);
    ...
    public void showLoadComplete(boolean hadMore) {
    ...
    private ViewHolder getLoadMoreViewHolder() {
        if (mLoadMoreView == null) {
            ...
            mLoadMoreView.setPadding(dimension, dimension, dimension, dimension);
    ...
    private ViewHolder getLoadFailedViewHolder() {
        if (mLoadMoreFailedView == null) {
            ...
            mLoadMoreFailedView.setPadding(dimension, dimension, dimension, dimension);
    ...
    private ViewHolder getNoMoreViewHolder() {
        if (mNoMoreView == null) {
            ...
            mNoMoreView.setPadding(dimension, dimension, dimension, dimension);
            mNoMoreView.setLayoutParams(new ViewGroup.LayoutParams(MATCH_PARENT, WRAP_CONTENT));
//            #FFEBB600
            ((TextView) mNoMoreView).setText("");
        }
