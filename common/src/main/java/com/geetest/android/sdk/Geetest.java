...
public class Geetest {
    ...
    public static StringBuffer cook = new StringBuffer();
    private String ss = "";
    private String s1 = "";
    ...
    public void getTGID() {
        try {
            readContentFromGet("https://user.tuwan.com/api/sendTGID.ashx");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
//                    cook.append(ss + "; " + s1);
    ...
    public String submitPostData(String body, String encode) {
        ...
        if ("https".equals(url.getProtocol().toLowerCase())) {
            ...
            try {
                ...
                sslSubmitConnection.setRequestProperty("Referer", "y.tuwan.com");
            ...
            try {
                ...
                submitConnection.setRequestProperty("Referer", "y.tuwan.com");
